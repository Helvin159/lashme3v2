...
const HomeHero = () => {
	return (
		<section className='contianer relative tablet:px-12'>
			<img
				src={heroImg}
				className=' w-100 mx-auto rounded-4xl object-cover object-center'
				alt='hero'
			/>
			<div className='bg-rgba-white-0.4 backdrop-blur-sm rounded-2xl h-full absolute top-0 left-0 right-0 bottom-0 m-0'>
